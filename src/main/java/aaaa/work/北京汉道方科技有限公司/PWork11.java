	...
	public static void main(String[] args) {
			...
			try {
				mainFuction(
						1, //1插入，2不插入
						"北京汉道方科技有限公司",//公司名称
						"http://www.handaofangkeji.com/cpzs",//网站网址
						1,//页数
						"id. view_list_9_37675_listul@@@li",//标签的element集合
						"",//图片地址包含完整时为“”，不完整填 域名
						"img@@@src",//获取图片标签
						"class. w-title@@@text",//获取商品名称
						"http://www.handaofangkeji.com",//产品url完整时为“”，不完整填 域名
						"a@@@href"//产品标签
				);
			} catch (Exception e) {
				e.printStackTrace();
