package aaaa.work.首选东华原医疗设备有限公司;
...
public class PWork11 {
	...
	public static void main(String[] args) {
		...
		//						2, //1插入，2不插入
		//						"首选东华原医疗设备有限公司",//公司名称
		//						"http://www.donghuayuan.com/product/index.html",//网站网址
		//						1,//页数
		//						"div.product_list@@@li",//标签的element集合
		//						"http://www.donghuayuan.com",//图片地址包含完整时为“”，不完整填 域名
		//						"img@@@src",//获取图片标签
		//						"span.fnt_24@@@a@@@text",//获取商品名称
		//						"http://www.donghuayuan.com",//产品url完整时为“”，不完整填 域名
		//						"a@@@href"//产品标签
		//				);
		String html = Template_P.getGoodsHtml("http://www.donghuayuan.com/product/index.html");
		Document doc = Jsoup.parse(html);

		Elements elements = doc.select("div.product_list li");
		List<String> list = new ArrayList<>();
		elements.forEach(element -> list.add("http://www.donghuayuan.com" + element.select("a").get(0).attr("href")));
		...
		for (int i = 0; i < list.size(); i++) {
			...
			try {
				mainFuction(
						1, //1插入，2不插入
						"首选东华原医疗设备有限公司",//公司名称
						list.get(i).replaceAll("\\.html","_@@@.html"),//网站网址
						1000,//页数
						"div.tisane_list@@@li",//标签的element集合
						"http://www.donghuayuan.com",//图片地址包含完整时为“”，不完整填 域名
						"img@@@src",//获取图片标签
						"h2.fnt_24@@@a@@@text",//获取商品名称
						"http://www.donghuayuan.com",//产品url完整时为“”，不完整填 域名
						"a@@@href"//产品标签
				);
			} catch (Exception e) {
