	...
	public static void main(String[] args) {
			...
			try {
				mainFuction(
						1, //1插入，2不插入
						"首选东华原医疗设备有限公司",//公司名称
						"http://www.swhybj.com/Product.aspx?m=351&page=@@@",//网站网址
						8,//页数
						"div.list@@@li",//标签的element集合
						"http://www.swhybj.com",//图片地址包含完整时为“”，不完整填 域名
						"img@@@src",//获取图片标签
						"div.title@@@a@@@text",//获取商品名称
						"http://www.swhybj.com/",//产品url完整时为“”，不完整填 域名
						"a@@@href"//产品标签
				);
			} catch (Exception e) {
				e.printStackTrace();
