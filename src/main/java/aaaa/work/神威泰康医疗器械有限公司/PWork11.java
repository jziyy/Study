package aaaa.work.神威泰康医疗器械有限公司;
	...
	public static void main(String[] args) {
			...
			try {
				mainFuction(
						1, //1插入，2不插入
						"神威泰康医疗器械有限公司",//公司名称
						"http://www.swtkyl.com/chanpinzhanshi/index_@@@.html",//网站网址http://www.sanjack.com.cn/class/view?id=10294&page=1000
						8,//页数
						"div.ml@@@dl",//标签的element集合
						"http://www.swtkyl.com",//图片地址包含完整时为“”，不完整填 域名
						"img@@@src",//获取图片标签
						"class.title_pro bule@@@a@@@text",//获取商品名称
						"http://www.swtkyl.com",//产品url完整时为“”，不完整填 域名
						"a@@@href"//产品标签
				);
			} catch (Exception e) {
				e.printStackTrace();
