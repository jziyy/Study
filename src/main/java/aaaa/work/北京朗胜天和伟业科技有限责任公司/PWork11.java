package aaaa.work.北京朗胜天和伟业科技有限责任公司;
	...
	public static void main(String[] args) {
			...
			try {
				mainFuction(
						1, //1插入，2不插入
						"北京英诺特生物技术有限公司",//公司名称
						"http://www.langshengtianhe.com/index.php?_m=mod_product&_a=prdlist&p=@@@",//网站网址
						7,//页数
						"div.prod_list_list",//标签的element集合
						"http://www.langshengtianhe.com/",//图片地址包含完整时为“”，不完整填 域名
						"div.prod_list_pic@@@img@@@src",//获取图片标签
						"div.prod_list_name@@@a@@@text",//获取商品名称
						"http://www.langshengtianhe.com/",//产品url完整时为“”，不完整填 域名
						"a@@@href"//产品标签
				);
			} catch (Exception e) {
				e.printStackTrace();
