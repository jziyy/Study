package aaaa.work.北京三捷欧技医疗器械有限公司;
...
public class PWork11 {
	...
	public static void main(String[] args) {
		...
		String html = Template_P.getGoodsHtml("http://www.sanjack.com.cn/class/view?id=10293");
		Document doc = Jsoup.parse(html);

		Elements elements =doc.getElementsByAttributeValue("class","left fl").select("a");
		...
		for (int i = 0; i < elements.size(); i++) {
			...
			try {
				mainFuction(
						state, //1插入，2不插入
						"北京三捷欧技医疗器械有限公司",//公司名称
						elements.get(i).attr("href") + "&page=@@@",//网站网址http://www.sanjack.com.cn/class/view?id=10294&page=1000
						1000,//页数
						"ul.cplist@@@li",//标签的element集合
						"http://www.sanjack.com.cn",//图片地址包含完整时为“”，不完整填 域名
						"img@@@src",//获取图片标签
						"p@@@text",//获取商品名称
						"",//产品url完整时为“”，不完整填 域名
						"a@@@href"//产品标签
