package aaaa.work.北京东方逸腾数码医疗设备技术有限公司;
...
public class PWork11 {
	...
	public static void main(String[] args) {
		try {
			mainFuction(
					1, //1插入，2不插入
					"北京东方逸腾数码医疗设备技术有限公司",//公司名称
					"http://www.oriental-et.com/product/li/1.html",//网站网址
					1,//页数
					"div.one_list",//标签的element集合
					"http://www.oriental-et.com",//图片地址包含完整时为“”，不完整填 域名
					"class.pic f_l@@@img@@@src",//获取图片标签
					"div.infos@@@b@@@text",//获取商品名称
					"http://www.oriental-et.com",//产品url完整时为“”，不完整填 域名
					"a@@@href"//产品标签
					);
		} catch (Exception e) {
			e.printStackTrace();
